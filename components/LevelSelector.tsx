    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
        <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-slate-50/50">
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase">Select Match</h2>
            <p className="text-slate-400 font-bold text-xs uppercase tracking-widest mt-1">{TOTAL_LEVELS} Tournaments from Amateur to Professional</p>
          </div>
        ...
        <div className="p-6 bg-slate-50 border-t border-slate-100 text-center text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">
          Win {TOTAL_LEVELS} handcrafted matches to unlock the Grand Prize
        </div>
      </div>
    </div>
  );
